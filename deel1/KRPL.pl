...
check( _US..W..Rx : Ry..Bx : By.. _D ) :-
	...
	Rx : Ry \== Bx : By,
	not inway( Rx : Ry, W, Bx : By ). % not w. king between w. rook and b. king

% Queen is in same row, column or diagonally from the black king
check( _US..W..Qx : Qy..Bx : By.. _D ) :-
	...
	Qx : Qy \== Bx : By,
	not inway( Qx : Qy, W, Bx : By ). % not w. king between w. queen and b. king
